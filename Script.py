...
🧠 ᴊᴜꜱᴛ ɢɪᴠᴇ ᴍᴇ ᴛʜᴇ ᴄᴏʀʀᴇᴄᴛ ɴᴀᴍᴇ ᴏꜰ ᴀ ᴍᴏᴠɪᴇ, ᴀɴᴅ ɪ’ʟʟ ᴡᴏʀᴋ ᴍʏ ᴍᴀɢɪᴄ! 🌟🔍

💡 ʜᴏᴡ ɪᴛ ᴡᴏʀᴋꜱ:
1️⃣ ꜱᴇᴀʀᴄʜ ʏᴏᴜʀ ᴍᴏᴠɪᴇ 🎬🍿 – ᴇɴᴛᴇʀ ᴛʜᴇ ɴᴀᴍᴇ ʏᴏᴜ’ʀᴇ ʟᴏᴏᴋɪɴɢ ꜰᴏʀ.
2️⃣ ɢᴇᴛ ʀᴇꜱᴜʟᴛꜱ ✅ – ɪꜰ ɪᴛ’ꜱ ᴀᴠᴀɪʟᴀʙʟᴇ, ʏᴏᴜ’ʟʟ ʜᴀᴠᴇ ɪᴛ ɪɴꜱᴛᴀɴᴛʟʏ!
3️⃣ ᴄʜᴇᴄᴋ ʙᴀᴄᴋ ʟᴀᴛᴇʀ ⏳ – ɴᴏᴛ ꜰᴏᴜɴᴅ? ɪ’ʟʟ ᴀᴅᴅ ɪᴛ ʙᴀꜱᴇᴅ ᴏɴ ʏᴏᴜʀ ꜱᴇᴀʀᴄʜ ʜɪꜱᴛᴏʀʏ.

🕛 - ᴠᴇʀɪꜰʏ ᴏɴᴇ ᴛɪᴍᴇ ᴀɴᴅ ɢᴇᴛ ᴀɴʏ ᴍᴏᴠɪᴇ ᴛɪʟʟ ᴍɪᴅɴɪɢʜᴛ! 🎥
⚡ ᴘʀᴏ ᴛɪᴘ: ᴋᴇᴇᴘ ꜱᴇᴀʀᴄʜɪɴɢ ᴛᴏ ʜᴇʟᴘ ᴇxᴘᴀɴᴅ ᴍʏ ᴄᴏʟʟᴇᴄᴛɪᴏɴ! 🚀

ᴍᴀɴᴛᴀɪɴᴇᴅ ʙʏ : <a href="https://t.me/The_ZackRox">亗 тђє ༒ Z𝚊𝚌𝚔 R𝚘𝚡</a></b>"""
...
Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Mʏ Cᴏᴍᴍᴀɴᴅs.</b>"""
    ...
    ABOUT_TXT = """<b>
 🤖 ᴍʏ ɴᴀᴍᴇ : {}
 👨‍💻 ᴄʀᴇᴀᴛᴏʀ : <a href='https://t.me/The_ZackRox'>тђє ༒ Z𝚊𝚌𝚔 R𝚘𝚡</a>
 📚 ʟɪʙʀᴀʀʏ : Who Care 
 📝 ʟᴀɴɢᴜᴀɢᴇ : Hindi
 ♻️ ᴅᴀᴛᴀ ʙᴀsᴇ : Free One
 📡 ʜᴏsᴛᴇᴅ ᴏɴ  : My Laptop
 🥶 ʙᴜɪʟᴅ sᴛᴀᴛᴜs : Offline</b>"""

    STREAM_CAP = """Use MX Player / VLC Player To Watch Movies !!"""
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/Movie_Links_Hub)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
Nᴀᴍᴇ - {}"""
    ...
    ALRT_TXT = """This Is New For You...😒"""

    OLD_ALRT_TXT = """This Message Is Very Old...🥲"""

    CUDNT_FND = """<b>Wrong Name...!!!</b>"""

    I_CUDNT = """<b>❌ Do not send like this ❌

👉 Money Heist Season 1 Episode 3
👉 Kota Factory Season 2 Episode 5

✅ Write & send like this ✅
...
sᴛᴇᴘ 𝟸 : ᴍᴀᴋᴇ ᴀᴄᴄᴏᴜɴᴛ ᴏɴ Aɴʏ <a href=https://onylinks.com>Sʜᴏʀᴛᴇɴᴇʀ Wᴇʙsɪᴛᴇ</a>.
...
𝗠𝗲𝘀𝘀𝗮𝗴𝗲 <b>: {}</b>"""
    ...
    CAPTION = """<b><a href=https://t.me/Movie_Links_Hub>{file_name}</a></b>"""
