...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            ...
            [
                InlineKeyboardButton(
                    "👻 ᴍᴏᴠɪᴇ ᴄʜᴀɴɴᴇʟ", url="https://t.me/Movie_Links_Hub"
                ),
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        await client.send_message(
            ...
            text="**👉 Firstly Join My BB Channel....😒\n👉 Then Click On Try Again....😎**",
    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        if is_valid == True:
            await message.reply_text(
                text=f"<b>Vrified Successfully! ✅</b>",
    ...
    if data.startswith("sendfiles"):
        ...
        for file in files:
            ...
            if (
                ...
                await message.reply_text(
                    text="<b>First 15 Seconds Verifcation Necessary !\n\nThen You Can Enjoy Unlimited Movies । ✅</b>",
                    protect_content=True,
                    reply_markup=InlineKeyboardMarkup(btn),
                )
                return
    ...
    if not await check_verification(client, message.from_user.id) and VERIFY == True:
        ...
        await message.reply_text(
            text="<b>First 15 Seconds Verifcation Necessary !\n\nThen You Can Watch Unlimited Movies । ✅</b>",
            protect_content=True,
            reply_markup=InlineKeyboardMarkup(btn),
        )
        return
...
async def shortlink(bot, message):
    ...
    if chat_type == enums.ChatType.PRIVATE:
        return await message.reply_text(
            ...
            "{your_shortener_website_name} {your_shortener_api}\n\n#Sample:-\n/shortlink onylinks.com 1f1da5c9df9a58058672ac8d8134e203b03426a1\n\nThat's it!!! Enjoy Earning Money 💲\n\n[[[ Trusted Earning Site - onylinks.com ]]]\n\nIf you have any Doubts, Feel Free to Ask me - @BBHUB_AdminBot</b>"
        )
    elif chat_type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
    ...
    try:
        ...
        return await message.reply_text(
            "<b>Command Incomplete :(\n\nGive me a shortener website link and api along with the command !\n\nFormat: <code>/shortlink pocolinks.com 1f1da5c9df9a58058672ac8d8134e203b03426a1</code></b>"
        )
