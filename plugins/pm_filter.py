...
async def pm_text(bot, message):
    ...
    await message.reply_text(text=f"<b>Type & Get - @BB_HUB_Chat</b>")
    ...
    try:
        if settings["max_btn"]:
            ...
            if n_offset == 0:
                ...
                btn.append(
                    [
                        InlineKeyboardButton(
                            "𝗦𝗲𝗻𝗱 𝗔𝗹𝗹 𝗙𝗶𝗹𝗲𝘀", callback_data=f"sendfiles#{key}"
                        )
                    ]
                )
        ...
        if n_offset == 0:
            btn.append(
                [
                    InlineKeyboardButton(
                        "ack", callback_data=f"next_{req}_{key}_{off_set}"
                    ),
                    InlineKeyboardButton(
                        f"{math.ceil(int(offset)/10)+1} / {math.ceil(total/10)}",
                        callback_data="pages",
                            ...
                            if seas == "season 6"
                                ...
                                if seas == "season 7"
                                    ...
                                    if seas == "season 8"
                                        ...
                                        "s09"
                                        if seas == "season 9"
                                        else "s10" if seas == "season 10" else ""
                                    )
                                )
                            )
                        )
                        ...
                        if seas == "season 5"
                            ...
                            if seas == "season 6"
                                ...
                                if seas == "season 7"
                                    ...
                                    "season 08"
                                    if seas == "season 8"
                                    else "season 09" if seas == "season 9" else "s010"
                                )
                            )
                        )
                    )
    ...
    if query.data.startswith("file"):
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                await query.answer(
                    "I Have Sent You A Movie In Personal Chat...✅\n\nFile Sent Successfully ✅",
                    show_alert=True,
                )
        ...
        btn2 = [
            ...
            [
                InlineKeyboardButton(
                    "Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ Lɪɴᴋ", url="https://t.me/BB_HUB_Chat"
                )
            ],
        ]
        if query.from_user.id in ADMINS:
            ...
            await log_msg.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "📥 ᴅᴏᴡɴʟᴏᴀᴅ 📥", url=lazy_download
                            ),  # we download Link
                            InlineKeyboardButton("🖥️ ꜱᴛʀᴇᴇᴍ 🖥️", url=lazy_stream),
                        ]
                    ]
                ),  # web stream Link
            )
            ...
            if settings["max_btn"]:
                ...
                btn.append(
                    [
                        ...
                        InlineKeyboardButton(
                            text="Nxet", callback_data=f"next_{req}_{key}_{offset}"
                        ),
                    ]
                )
                btn.append(
